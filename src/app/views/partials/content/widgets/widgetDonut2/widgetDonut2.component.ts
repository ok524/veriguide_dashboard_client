...
@Component({
  selector: 'kt-widgetDonut2',
  templateUrl: './widgetDonut2.component.html',
  styleUrls: ['./widgetDonut2.component.scss'],
})
export class WidgetDonut2Component implements OnInit {
  // Public properties
  @Input() title: string;
  @Input() desc: string;
