...
import { SubmissionTableService, SubmissionTableItemModel } from '../../../../../../core/_base/layout';
...
**/
export class SubmissionTableDataSource implements DataSource<SubmissionTableItemModel> {
  // Public properties
  ...
  baseFilter(_entities: any[], _queryParams: QueryParamsModel): QueryResultsModel {
    ...
    this.submissionTableService.getAllItems().pipe(
      tap(res => {
