...
import { UserTableService, UserTableItemModel } from '../../../../../../core/_base/layout';
...
**/
export class UserTableDataSource implements DataSource<UserTableItemModel> {
  // Public properties
  ...
  baseFilter(_entities: any[], _queryParams: QueryParamsModel): QueryResultsModel {
    ...
    this.userTableService.getAllItems("23456").pipe(
      tap(res => {
